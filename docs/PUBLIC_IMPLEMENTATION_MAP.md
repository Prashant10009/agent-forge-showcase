...
Those relationships are inspectable in source and enforced by the test suite. The larger private codebase remains necessary because real providers, persistence, streaming, APIs, product surfaces, integrations, deployment and operational recovery multiply each boundary. Those details stay private by design.
